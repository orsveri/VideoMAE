...
#SBATCH --output=jobs/job_outputs/pretrain_triple_%j.out
...
OUTPUT_DIR='logs/my_pretrain/vits_vidmae_k400/bdd-shift-capdata_lightcrop_b200x4_mask075'
# path to data set 
DATA_PATH1='/scratch-nvme/ml-datasets/bdd100k/videos'
DATA_PATH2='/gpfs/work3/0/tese0625/datasets/SHIFT'
DATA_PATH3='/gpfs/work3/0/tese0625/RiskNetData/LOTVS-DADA/CAP-DATA'
