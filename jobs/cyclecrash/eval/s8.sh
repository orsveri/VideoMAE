...
#SBATCH --output=jobs_cc/eval_s8_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/cc/s8_convnext_dada_lr2e6_/eval_DoTA_ckpt_bestap'
# path to data set 
DATA_PATH1='/gpfs/work3/0/tese0625/RiskNetData/DoTA_refined'
DATA_PATH2="/gpfs/work3/0/tese0625/RiskNetData/LOTVS-DADA/DADA2K"
MODEL_PATH='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/cc/s8_convnext_dada_lr2e6_/checkpoint-bestap/mp_rank_00_model_states.pt'
