...
#SBATCH --output=jobs_cc/eval_s12h_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/cc/s12h_r2p1d_dadah/eval_DoTA_ckpt_bestap'
# path to data set 
DATA_PATH1='/gpfs/work3/0/tese0625/RiskNetData/DoTA_refined'
DATA_PATH2="/gpfs/work3/0/tese0625/RiskNetData/LOTVS-DADA/DADA2K"
MODEL_PATH='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/cc/s12h_r2p1d_dadah/checkpoint-bestap/mp_rank_00_model_states.pt'
