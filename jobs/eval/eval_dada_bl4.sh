...
#SBATCH --output=jobs_outs_eval/216_dada_%j.out
...
OUTPUT_DIR='logs/ft_after_pretrain/216_VITB_dadah_lr5e_b28x2_dsampl1val3_ld06_aam6n3/eval_DADA2K_ckpt_bestap'
# path to data set 
