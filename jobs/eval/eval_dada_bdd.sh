...
#SBATCH --output=jobs/job_outputs/eval_dada_bdd_%j.out
...
OUTPUT_DIR='logs/my_pretrain_ft_dota/bdd100k_extra_pretrain_vits/from-k400_full_regular_b200x4_mask075-session2_newaug/ckpt-4-dada-res'
# path to data set 
