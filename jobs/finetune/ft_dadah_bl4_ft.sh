...
#SBATCH --output=jobs_outs/FIX_216_bl4_dadah_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/ft_after_pretrain/216_VITB_dadah_lr5e_b28x2_dsampl1val3_ld06_aam6n3'
# path to data set 
DATA_PATH="/gpfs/work3/0/tese0625/RiskNetData/LOTVS-DADA/DADA2K"
# 'logs/pretrained/vivit/vivit-b-16x2-kinetics400_vidmae.pth'
MODEL_PATH='/gpfs/work3/0/tese0625/VideoMAE_results/train_logs/my_pretrain/bl4_vivit_bdd-capdata_lightcrop_b200x4_mask075/checkpoint-11.pth'
