...
#SBATCH --output=jobs/job_outputs/eft_dotah_bl1_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/ft_after_pretrain/bl1k700/dotah_lr1e3_b28x2_dsampl1val2_ld06_aam6n3'
# path to data set 
...
MODEL_PATH='logs/my_pretrain/bl1_vits_k700/checkpoint-23.pth'
