...
#SBATCH --output=jobs/job_outputs/ft_dada_bl2_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/baselines/bl2/dada_lr5e4_b56x1_dsampl1val3_ld06_aam6n3'
# path to data set 
