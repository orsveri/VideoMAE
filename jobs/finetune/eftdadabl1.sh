...
#SBATCH --output=jobs/job_outputs/eft_dada_bl1_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/ft_after_pretrain/bl1k700/dada_lr1e3_b56x1_dsampl1val3_ld06_aam6n3'
# path to data set 
