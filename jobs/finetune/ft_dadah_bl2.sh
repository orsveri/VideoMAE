...
#SBATCH --output=jobs_outs_ftpt/208_bl2_dadah_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/ft_after_pretrain/bl2/dadah_lr1e3_b28x2_dsampl1val3_ld06_aam6n3'
# path to data set 
