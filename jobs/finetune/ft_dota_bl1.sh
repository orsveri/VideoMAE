...
#SBATCH --output=jobs/job_outputs/ft_dota_bl1_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/baselines/bl1/lr1e3_b56x1_dsampl1val2_ld06_aam6n3'
# path to data set 
