...
#SBATCH --output=jobs/job_outputs/ft_dota_AMNET_bdd_%j.out
...
OUTPUT_DIR='logs/ft_after_pretrain/pt_bdd-capdata/dotaamnet_lr1e3_b28x2_dsampl1val2_ld06_aam6n3'
# path to data set 
DATA_PATH='/gpfs/work3/0/tese0625/RiskNetData/DoTA_refined'
# path to pretrain model
MODEL_PATH='logs/my_pretrain/vits_vidmae_k400/bdd-capdata_lightcrop_b200x4_mask075/checkpoint-11.pth'
