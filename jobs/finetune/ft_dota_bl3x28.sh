...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/baselines/bl3/dota_lr1e3_b28x2_dsampl1val2_ld06_aam6n3'
# path to data set 
DATA_PATH='/gpfs/work3/0/tese0625/RiskNetData/DoTA_refined'
# path to pretrain model
# 'logs/pretrained/InternVideo/IntVid2_s14_single_dist1B.bin'
MODEL_PATH='logs/pretrained/InternVideo/IntVid2_s14_single_dist1B.bin'
