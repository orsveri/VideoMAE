...
#SBATCH --output=jobs/job_outputs/ft_dadaH_bl1_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/baselines/bl1/dadaH_lr5e4_b28x2_dsampl1val3_ld06_aam6n3'
# path to data set 
