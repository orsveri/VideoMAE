...
#SBATCH --output=jobs/job_outputs/eft_dadah_bl1_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/ft_after_pretrain/bl1k700/dadah_lr1e3_b28x2_dsampl1val3_ld06_aam6n3'
# path to data set 
DATA_PATH="/gpfs/work3/0/tese0625/RiskNetData/LOTVS-DADA/DADA2K"
# path to pretrain model
MODEL_PATH='/gpfs/work3/0/tese0625/VideoMAE_results/train_logs/my_pretrain/bl1_vits_k700/checkpoint-23.pth'
