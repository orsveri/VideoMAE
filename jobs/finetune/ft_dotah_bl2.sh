...
#SBATCH --output=jobs_outs_ftpt/206_bl2_dotah_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/ft_after_pretrain/bl2/dotah_lr1e3_b28x2_dsampl1val2_ld06_aam6n3'
# path to data set 
