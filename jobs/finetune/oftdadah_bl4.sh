...
#SBATCH --output=jobs_outs_ftpt/16_bl4_dadah_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/baselines/bl4/VITB_dadah_lr5e_b28x2_dsampl1val3_ld06_aam6n3'
# path to data set 
