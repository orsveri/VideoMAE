...
#SBATCH --output=jobs_outs_ftpt/14_bl4_dotah_%j.out
...
OUTPUT_DIR='/home/sorlova/repos/AITHENA/NewStage/VideoMAE/logs/baselines/bl4/VITB_dotah_lr5e4_b28x2_dsampl1val2_ld06_aam6n3'
# path to data set 
