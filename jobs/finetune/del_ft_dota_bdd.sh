...
#SBATCH --output=jobs/job_outputs/ft_dota_bdd_%j.out
...
OUTPUT_DIR='logs/my_pretrain_ft_dota/extra_pretrain1/full_ld06_strongeraug_strongerdrop'
# path to data set 
DATA_PATH='/gpfs/work3/0/tese0625/RiskNetData/DoTA_refined'
# path to pretrain model
MODEL_PATH='logs/my_pretrain/bdd100k_extra_pretrain_vits/lightcrop_from-k400_full_regular_b200x4_mask075/checkpoint-11.pth'
...
torchrun --nproc_per_node=1 \
    ...
    --drop_path 0.2 \
    --layer_decay 0.6 \
    --aa rand-m6-n4-mstd0.5-inc1 \
    --freeze_layers "first N blocks;8" \
    --epochs 10 \
    --test_num_segment 1 \
    --test_num_crop 1 \
    --dist_eval \
