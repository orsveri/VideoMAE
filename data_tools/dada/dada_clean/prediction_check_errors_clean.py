...
# "_fixttc" ?
predictions1 = "/home/sorlova/repos/NewStart/VideoMAE/logs/clean_datasets/DADA2K/b32x2x1gpu_ce_TRAIN/checkpoint-{}/OUTtrain/predictions_0.csv"
...
# _labels = ["night_score", "night_far_score", "day_score", "day_far_score"]
...
nd_bad81 = len(err_df[err_df["err_far_score"] > 0.15])
...
nd_bad0p = len(err_df[err_df["err_far_score"] > 0.02])
nd_bad0q = len(err_df[err_df["err_far_score"] > 0.015])
nd_bad0m = len(err_df[err_df["err_far_score"] > 0.012])
nd_bad0k = len(err_df[err_df["err_far_score"] > 0.01])
