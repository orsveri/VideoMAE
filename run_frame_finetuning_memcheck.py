...
from engine_for_frame_finetuning import validation_one_epoch, final_test, merge
...
# Context manager to use tracemalloc for profiling
@contextmanager
...
from engine_for_frame_finetuning import train_class_batch_ttc, train_class_batch, calculate_metrics, get_loss_scale_for_deepspeed
...
def train_one_epoch(model: torch.nn.Module, criterion: torch.nn.Module,
    ...
    for data_iter_step, (samples, targets, _, ttc) in enumerate(metric_logger.log_every(data_loader, print_freq, header)):
        ...
        print(f"[Profiler] Finished profiling batch {data_iter_step} in epoch {epoch}")
